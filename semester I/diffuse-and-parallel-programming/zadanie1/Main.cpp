...
//        cout << life->getCellState(5999,5999) << life->getCellState(5999,6000) << life->getCellState(5999,6001) << endl;
//        cout << life->getCellState(6000,5999) << life->getCellState(6000,6000) << life->getCellState(6000,6001) << endl;
//        cout << life->getCellState(6001,5999) << life->getCellState(6001,6000) << life->getCellState(6001,6001) << endl;
    }
